...
class HclusterMnist(object):
    def __init__(self):
        Xtrain, Ytrain, Xtest , Ytest = get_data()
        print("Number of classes in train set: ",len(set(Ytrain)))
        print("Number of classes in test  set: ",len(set(Ytest)))
...
if __name__ == "__main__":
    cluster = HclusterMnist()
    cluster.pca_data()
    cluster.run()

    # Here you can clearly see that single linkage extremely effected by  chaining effect
    # Due to feature reduction the ward linkage accuarcy also goes down